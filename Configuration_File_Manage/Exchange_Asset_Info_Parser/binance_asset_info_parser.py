...
@Description:  a specific implementation from base-class for Binance_Market_Data_Parse_Info ;
@Author: Jerry ;
@Date  : 23/1/25
Version: 1.0.0
Update Record:
...
from Configuration_File_Manage.Exchange_Asset_Info_Parser.base_asset_info_parser import Base_Exchange_Asset_Info_Parser
...
class Binance_Asset_Info_Parser(Base_Exchange_Asset_Info_Parser):
    def __init__(self):
        ...
        self.exchange = "Binance_Market_Data_Parse_Info"
